...
import { GitMerge, Activity, LayoutDashboard, TerminalSquare, LogOut, Sun, Moon } from 'lucide-react';
...
const Layout = () => {
    ...
    return (
        <div className="flex h-screen w-full bg-slate-50 dark:bg-slate-950 text-slate-600 dark:text-slate-400 overflow-hidden font-sans">
            ...
            {/* Sidebar */}
            <aside className="w-64 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 flex flex-col">
                <div className="p-6">
                    <NavLink to="/" className="flex items-center gap-2 mb-8 text-slate-900 dark:text-slate-100 font-medium hover:text-blue-600 transition-colors group">
                ...
                ${isActive ? 'bg-blue-500/10 text-blue-600 dark:text-blue-400' : 'hover:bg-slate-100 dark:hover:bg-slate-800/50 hover:text-slate-800 dark:text-slate-200'}
              `}
                        >
              ...
              `}
                ...
                <div className="mt-auto p-4 border-t border-slate-200 dark:border-slate-800/50">
                    <div className="flex items-center gap-3">
                        <NavLink to="/profile" className="flex items-center gap-3 flex-1 hover:bg-slate-100 dark:hover:bg-slate-800/50 p-2 rounded-lg transition-colors cursor-pointer group">
                            <div
            ...
            <main className="flex-1 flex flex-col relative overflow-hidden">
                {/* Topbar */}
                <header className="h-14 border-b border-slate-200 dark:border-slate-800 flex items-center px-6 justify-between bg-white dark:bg-slate-900/20 backdrop-blur-sm z-10 hidden sm:flex">
                    <div className="flex items-center gap-2 text-sm">
                        <span className="text-slate-500 text-xs font-mono">WORKSPACE</span>
                        <span className="text-slate-600 dark:text-slate-400">/</span>
                        <span className="text-slate-800 dark:text-slate-200 font-medium capitalize">CommitStream MVP</span>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2 px-3 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-full">
