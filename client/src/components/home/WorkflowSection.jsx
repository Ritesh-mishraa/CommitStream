...
import { Github, LayoutDashboard, Target, GitMerge, Bot } from 'lucide-react';
    ...
    return (
        <section className="w-full mt-32 relative overflow-hidden">
            ...
            <motion.div
                ...
                className="relative z-20 max-w-6xl mx-auto w-full px-6 py-24"
            >
                ...
                <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-8 relative z-10">
                        {[
                            ...
                            { step: "3", title: "Consult Repo AI", desc: "Chat with codebase files, structures, and diffs.", icon: <Bot className="w-5 h-5 text-slate-600 dark:text-slate-400" /> },
                            { step: "4", title: "Predict Conflicts", desc: "AI simulates merges to find breaking code.", icon: <Target className="w-5 h-5 text-slate-600 dark:text-slate-400" /> },
                            { step: "5", title: "Resolve & Merge", desc: "One-click safe resolution back to GitHub.", icon: <GitMerge className="w-5 h-5 text-slate-600 dark:text-slate-400" /> }
                        ].map((item, i) => (
