...
const RepoStatusPanel = ({ project, stats, setActiveProject }) => {
    ...
    return (
        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-5 h-full flex flex-col justify-between">
            <div>
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-slate-200 font-mono bg-slate-800 px-2 py-0.5 rounded">
            ...
            <div className="mt-6 pt-4 border-t border-slate-800 flex items-center justify-between">
                ...
                <div className="relative">
                    ...
                    <select
                        ...
                        className={`appearance-none bg-slate-950 border text-xs rounded-md pl-3 pr-8 py-1.5 focus:outline-none transition-colors 
                            ...
                            ${status === 'Archived' ? 'border-slate-700 text-slate-400 bg-slate-800' : ''}
                        `}
                    >
